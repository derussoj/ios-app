//
//  AddCocktailTableViewController.swift
//  Cheers
//
//  Created by Air on 6/27/15.
...
class AddCocktailTableViewController: UITableViewController, UITextFieldDelegate
{
    var entryMode: Int = 0
    ...
    override func viewDidLoad() {
        ...
        let tapGesture = UITapGestureRecognizer(target: self, action: #selector(AddCocktailTableViewController.hideKeyboard))
    ...
    func loadDrinkBeingEdited()
    {
        ...
        if bacEstimation == true
        {
            ...
            let timeFormatter = DateFormatter()
            timeFormatter.timeStyle = DateFormatter.Style.short
            let selectedTimeString = timeFormatter.string(from: selectedDateTime as Date)
            timeDetailLabel.text = selectedTimeString
                
            let dateFormatter = DateFormatter()
            dateFormatter.dateStyle = DateFormatter.Style.medium
            let selectedDateString = dateFormatter.string(from: selectedDateTime as Date)
            dateDetailLabel.text = selectedDateString
        }
    ...
    @IBAction func cancelToAddCocktail(_ segue:UIStoryboardSegue)
    {
        // Do nothing.
    }
    
    @IBAction func saveEntryModeToAddCocktail(_ segue:UIStoryboardSegue)
    {
        hasUnsavedChanges = true
    ...
    @IBAction func saveIngredientsToAddCocktail(_ segue:UIStoryboardSegue)
    {
        hasUnsavedChanges = true
    ...
    @IBAction func saveTimeToAddCocktail(_ segue:UIStoryboardSegue)
    {
        hasUnsavedChanges = true
    ...
    @IBAction func saveDateToAddCocktail(_ segue:UIStoryboardSegue)
    {
        hasUnsavedChanges = true
    ...
    @IBAction func saveLocationToAddCocktail(_ segue:UIStoryboardSegue)
    {
        hasUnsavedChanges = true
    ...
    @IBAction func saveCaptionToAddCocktail(_ segue:UIStoryboardSegue)
    {
        hasUnsavedChanges = true
    ...
    @IBAction func saveCocktailToAddCocktail(_ segue:UIStoryboardSegue)
    {
        /*
        if let cocktailSearchTableViewController = segue.sourceViewController as? CocktailSearchTableViewController
        {
            // Get selected cocktail from cocktailSearchTableViewController and update the name and ingredients.
        }
        */
    }
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell
    {
        ...
        {
            cell = tableView.dequeueReusableCellWithIdentifier("EntryModeCell", forIndexPath: indexPath) as! UITableViewCell
        }
        else if indexPath.section == 1
        {
            ...
            {
                cell = tableView.dequeueReusableCellWithIdentifier("DrinksCell", forIndexPath: indexPath) as! UITableViewCell
            }
            else if indexPath.row == 2
            {
                cell = tableView.dequeueReusableCellWithIdentifier("AddIngredientCell", forIndexPath: indexPath) as! UITableViewCell
            }
            else
            {
                cell = tableView.dequeueReusableCellWithIdentifier("IngredientsCell", forIndexPath: indexPath) as! UITableViewCell
            }
        }
        else
        {
            ...
            {
                cell = tableView.dequeueReusableCellWithIdentifier("CaptionCell", forIndexPath: indexPath) as! UITableViewCell
            }
        }
    ...
    */
    ...
    override func shouldPerformSegue(withIdentifier identifier: String, sender: Any?) -> Bool
    {
        ...
        if identifier == "CocktailSelection"
        {
            nameTextField.text = nameTextField.text?.trimmingCharacters(in: .whitespacesAndNewlines)
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?)
    {
        if segue.identifier == "EntryModeSelection"
        {
            ...
            {
                entryModeTableViewController.sendingView = "AddCocktail"
        ...
        else if segue.identifier == "AddIngredients"
        {
            ...
            {
                addIngredientsTableViewController.sendingView = "AddCocktail"
        ...
        else if segue.identifier == "TimeSelection"
        {
            ...
            {
                timeViewController.sendingView = "AddCocktail"
        ...
        else if segue.identifier == "DateSelection"
        {
            ...
            {
                dateViewController.sendingView = "AddCocktail"
        ...
        else if segue.identifier == "LocationSelection"
        {
            ...
            {
                locationTableViewController.sendingView = "AddCocktail"
            }
        }
        ...
        else if segue.identifier == "CaptionEntry"
        {
            ...
            {
                captionTableViewController.sendingView = "AddCocktail"
        ...
        else if segue.identifier == "CocktailSelection"
        {
            /*
            if let cocktailSearchTableViewController = segue.destinationViewController.topViewController as? CocktailSearchTableViewController
            {
                var cocktailText = nameTextField.text.stringByTrimmingCharactersInSet(NSCharacterSet.whitespaceAndNewlineCharacterSet())
            
                // Validate this above?
                cocktailText = cocktailText.stringByAddingPercentEncodingWithAllowedCharacters(NSCharacterSet.URLQueryAllowedCharacterSet())!
            
                cocktailSearchTableViewController.searchText = cocktailText
            }
            */
        }
    }
    ...
    func saveDrinkToParse(currentDateTime: Date) -> String
    {
        ...
        else if entryMode == 1
        {
            ...
            if bacEstimation == true
            {
                drinkEntry.effectiveDrinkCount = calculateEffectiveDrinkCount()
            }
        }
    ...
    func saveDrinkLocally(currentDateTime: Date, objectID: String)
    {
        ...
        drinkEntry.setValue("cocktail", forKey: "type")
